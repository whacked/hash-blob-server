(defproject hash-blob-server "0.1.0-SNAPSHOT"
  ...
  :main ^:skip-aot hash-blob-server.core
  ...
  {:nrepl {:port 7002}
   ...
   {:app
    {:target :browser
     ...
     :asset-path "/js"
     :modules {:app {:entries [hash-blob-server.app]}}
  ...
  {:uberjar {:omit-source true
             ...
             :aot :all
             :uberjar-name "hash-blob-server.jar"
